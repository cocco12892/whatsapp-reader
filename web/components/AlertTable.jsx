...
const BettingMatrix = ({ data, onClose, calculateThreeWayNVP, calculateTwoWayNVP }) => {
          ...
          {showMatrix && matrixData && (
            <Box sx={{ 
              ...
              <BettingMatrix 
                ...
                calculateThreeWayNVP={calculateThreeWayNVP}
                calculateTwoWayNVP={calculateTwoWayNVP}
              />
            </Box>
          )}
